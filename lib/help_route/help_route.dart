...
class HelpPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        color: ThemeController().getColor("help_page_background"),
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text(
                    AppLocalizations.of(context).translate('help_page_content'),
                    style: TextStyle(
                      fontSize: 22,
                      color:
                          ThemeController().getColor("help_page_content_text"),
                    ),
                  ),
                )
              ],
